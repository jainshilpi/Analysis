...
class GlobeHLT {
  ...
  */
  ...
  ULong64_t hlt1_bit_7;
  ULong64_t hlt1_bit_8;
  ULong64_t hlt1_bit_9;
  ULong64_t hlt1_bit_10;
  
  ULong64_t hlt1_bit[10];
  ...
  */
  ...
  ULong64_t hlt_candpath_7[MAX_HLT];
  ULong64_t hlt_candpath_8[MAX_HLT];
  ULong64_t hlt_candpath_9[MAX_HLT];
  ULong64_t hlt_candpath_10[MAX_HLT];

  ULong64_t hlt_candpath[10][MAX_HLT];
...
private:   
  ...
  std::vector<std::string> *hlt_label_names_7;
  std::vector<std::string> *hlt_label_names_8;
  std::vector<std::string> *hlt_label_names_9;
  std::vector<std::string> *hlt_label_names_10;
  ...
  std::vector<std::string> *hlt_path_names_HLT1_7;
  std::vector<std::string> *hlt_path_names_HLT1_8;
  std::vector<std::string> *hlt_path_names_HLT1_9;
  std::vector<std::string> *hlt_path_names_HLT1_10;
  ...
  std::vector<int> *hlt_prescales_HLT1_7;
  std::vector<int> *hlt_prescales_HLT1_8;
  std::vector<int> *hlt_prescales_HLT1_9;
  std::vector<int> *hlt_prescales_HLT1_10;
